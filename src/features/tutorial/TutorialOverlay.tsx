...
const STEPS: Step[] = [
  ...
  {
    id: 'click-dancer',
    title: 'Hacé click en un bailarín',
    text: 'Hacé click sobre cualquier bailarín del escenario para seleccionarlo y ver sus propiedades.',
    targetSelector: '#stage-canvas',
    action: 'wait-dancer-click',
  },
  {
    id: 'drag-dancer',
    title: 'Arrastrá un bailarín',
    text: 'Arrastrá cualquier bailarín para moverlo a una nueva posición.',
    targetSelector: '#stage-canvas',
    action: 'wait-drag',
  },
  {
  ...
  },
  {
    ...
    text: 'Manteniendo Ctrl (o Cmd), hacé click en 3 o más bailarines para seleccionarlos juntos.',
    targetSelector: '#stage-canvas',
  ...
  },
  {
    ...
    text: 'Hacé click en el botón ⧉ para duplicar la escena actual con todos sus bailarines.',
  ...
  },
  {
    ...
    text: 'Hacé click en la escena 1 y reorganizá los bailarines para crear una formación diferente.',
    targetSelector: '#stage-canvas',
    action: 'click-next',
  },
  {
